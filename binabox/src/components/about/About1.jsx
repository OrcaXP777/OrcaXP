...
function About1(props) {
    ...
    const [dataBlock] = useState(
        {
            heading: 'OrcaXP',
            desc: 'Born from a penguin in an orca hoodie Fueled by XP ⚡ A coin for degens, gamers, memers, and keyboard warriors! OXP: BUY to level up, miss it and fall behind'

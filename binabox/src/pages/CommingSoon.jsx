            ...
            <section className="comming-soon ">
                ...
                <div className="comming-soon-inner">
                    ...
                    {/* <div className="group-btn">
                        <Link to="https://discord.gg/eBYd99jE" className="tf-button discord" data-toggle="modal" data-target="#popup_bid"><i className="icon-fl-vt"></i><span>DISCORD</span></Link>
                    ...
                    <ul className="social-item">
                        <li><Link to="https://discord.gg/eBYd99jE"><i className="icon-fl-vt"></i></Link></li>
                        <li><Link to="https://x.com/OrcaXP777"><i className="fab fa-twitter"></i></Link></li>

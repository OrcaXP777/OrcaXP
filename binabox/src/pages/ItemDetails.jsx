                            ...
                            <div className="tf-item-detail-inner">
                                ...
                                <div className="group-btn">
                                   ...
                                   <div className="group-2">
                                        <Link to="https://discord.gg/eBYd99jE" className="tf-button style-2 "><i className="icon-fl-vt"></i> JOIN DISCORD</Link>
                                        <Link to="https://x.com/OrcaXP777" className="tf-button style-2 twitter"><i className="fab fa-twitter"></i> JOIN TWITTER</Link>
                                   </div>
                                </div>
                            </div>
                        </div>
